...
2. Apply the dashboard Tags pill override to `theme_edutor/scss`.
3. Reset all private dashboards with Moodle's built-in `my_reset_page_for_all_users(MY_PAGE_PRIVATE, 'my-index')`.
