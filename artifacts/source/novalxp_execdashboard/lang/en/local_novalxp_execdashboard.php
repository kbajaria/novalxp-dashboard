...
$string['section_alltimekpis'] = 'All-time overview';
$string['tile_totalusers'] = 'Total users in system';
$string['tile_everenrolled'] = 'Learners ever enrolled';
$string['tile_totalcompletions'] = 'Total course completions';
...
$string['section_topenrolmentschart'] = 'Top 10 courses by enrolment';
$string['chart_enrolments_series'] = 'Active enrolments';
$string['empty_topenrolmentschart'] = 'No course enrolment data matched the current filters.';
$string['section_completionratechart'] = 'Completion rate by course';
$string['chart_completionrate_series'] = 'Completion rate (%)';
$string['empty_completionratechart'] = 'No course data matched the current filters.';
$string['section_engagementfunnel'] = 'Engagement funnel';
$string['funnel_potentialusers'] = 'Potential users';
$string['funnel_everenrolledusers'] = 'Ever enrolled (all time)';
$string['funnel_newenrolmentusers'] = 'New enrolments in period';
$string['funnel_startedlearners'] = 'Started learning';
$string['funnel_completedusers'] = 'Completions';
$string['funnel_series_label'] = 'Learners';
