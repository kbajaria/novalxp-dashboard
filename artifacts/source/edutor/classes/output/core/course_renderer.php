 ...
 * Course renderer.
 *
 * @package    theme_edutor
 * @copyright  2017 Willian Mano - conecti.me
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */

namespace theme_edutor\output\core;
...
//use coursecat; //Moodle 3.8+ Class 'coursecat' has been renamed for the autoloader and is now deprecated. Please use 'core_course_category' instead.
use core_course_category; //Moodle 3.8+
...
/**
 * Renderers to align edutor's course elements to what is expect
 *
 * @package    theme_edutor
...
class course_renderer extends \core_course_renderer {
    ...
    protected function coursecat_courses(coursecat_helper $chelper, $courses, $totalcount = null) {
        ...
        if ($PAGE->theme->settings->coursedisplaystyle == 2) {
	        $courseboxclass .= ' col-12 col-md-6 col-lg-4 col-xl-3';
        }
    ...
    protected function coursecat_coursebox_content(coursecat_helper $chelper, $course) {
        ...
        $cleancoursesummary = theme_edutor_strip_html_tags($coursesummary);//Clean course summary - strip html tags (function defined in lib.php)
        $cleancoursesummarytrim = theme_edutor_course_trim_char($cleancoursesummary, $coursesummarylength);//Trim course summary (function defined in lib.php)
    ...
    protected function get_course_summary_image($course) {
        ...
        foreach ($course->get_course_overviewfiles() as $file) {
            ...
            /* Moodle <= 5.0: use file_encode_url().
            ...
            */
            ...
            // Moodle 5.1+: use the URL factory instead of file_encode_url().
            $url = \core\url::make_pluginfile_url(
	            ...
	            $file->get_filepath(),
	            $file->get_filename(),
	            !$isimage // forcedownload if not an image
	        )->out(false);
